...
const Clouds = () => {
  return (
    <div className=''>
      ...
      <section
        className='text-gray-600 body-font relative inline-block align-middle w-full'
        id='contact'
      >
        <div className='container px-5 py-24 mx-auto'>
          <div className='flex flex-col text-center w-full mb-12'>
            ...
            <p className='lg:w-2/3 mx-auto leading-relaxed text-lg text-gray-300'>
              I am currently looking for oppurtunities as a Full Stack
              Developer. My inbox is always open to anyone who wants to connect
              with me.
            </p>
          </div>
          <div className='lg:w-1/2 md:w-2/3 mx-auto'>
            <div className='flex flex-wrap -m-2'>
              <div className='p-2 w-full'>
                <a href='mailto:burhanraja02@yahoo.com'>
          ...
          <div className='contact-social flex flex-row justify-center w-full mb-12 mt-2'>
            <div className='twitter-btn mx-2'>
              <a href='https://twitter.com/Burhan_Raja52'>
                <button className='flex mx-auto bg-white hover:bg-cyan-400 font-bold rounded-full text-lg p-1'>
                  <img src='/assets/twitter.png' alt='' className='h-10 w-10' />
                </button>
              </a>
            </div>
            ...
            <div className='github-btn mx-2'>
              <a href='https://github.com/BurhanRaja'>
                <button className='flex mx-auto  bg-white hover:bg-cyan-400 font-bold rounded-full text-lg p-1'>
                  <img src='/assets/github.png' alt='' className='h-10 w-10' />
                </button>
              </a>
            </div>
          </div>
